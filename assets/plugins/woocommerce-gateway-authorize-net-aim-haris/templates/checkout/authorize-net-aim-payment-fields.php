...
<fieldset>
	<div class="wc-authorize-net-aim-new-payment-method-form js-wc-authorize-net-aim-new-payment-method-form">
		<p class="form-row form-row-first">
            ...
            <input type="text" class="input-text js-wc-payment-gateway-account-number" id="wc-authorize-net-aim-account-number" name="billing_creditcard" maxlength="19" autocomplete="off" value="<?php echo esc_attr( $payment_method_defaults['account-number'] ); ?>" />
		...
		<p class="form-row form-row-last">
            ...
            <select name="billing_expirymm" id="wc-authorize-net-aim-exp-month" class="js-wc-payment-gateway-card-exp-month" style="width:auto;">
            ...
            <select name="billing_expiryyy" id="wc-authorize-net-aim-exp-year" class="js-wc-payment-gateway-card-exp-year" style="width:auto;">
		...
		<?php if ( $enable_csc ) : ?>
			<p class="form-row form-row-wide">
                ...
                <input type="text" class="input-text js-wc-payment-gateway-csc" id="wc-authorize-net-aim-csc" name="billing_cvv" maxlength="4" style="width:60px" autocomplete="off" value="<?php echo esc_attr( $payment_method_defaults['csc'] ); ?>" />
			</p>
			<div class="clear"></div>
		<?php endif; ?>
