<?php
/**
 * Plugin Name: Autoship z - REQUIRED PLUGIN - Haris branched version of WooCommerce Authorize.net AIM Gateway
 * Original Plugin URI: http://www.woothemes.com/products/authorize-net-aim/
 * Description: Accept Credit Cards and eChecks via Authorize.net AIM in your WooCommerce store
 * Author: Haris Fudugo
 * Original Author: SkyVerge
 * Original Author URI: http://www.skyverge.com
 * Original Version: 3.3.1
 * Text Domain: woocommerce-gateway-authorize-net-aim-haris
...
// Plugin updates - DISABLED BY HARIS
...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '3.1.0', __( 'WooCommerce Authorize.net AIM Gateway', 'woocommerce-gateway-authorize-net-aim-haris' ), __FILE__, 'init_woocommerce_gateway_authorize_net_aim', array( 'is_payment_gateway' => true, 'minimum_wc_version' => '2.1', 'backwards_compatible' => '3.1.0' ) );
