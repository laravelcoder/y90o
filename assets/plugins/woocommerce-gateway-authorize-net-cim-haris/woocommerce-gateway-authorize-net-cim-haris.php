<?php
/**
 * Plugin Name: Autoship z - REQUIRED PLUGIN - KEEP DEACTIVATED, BUT DO NOT DELETE!
 * Orig Plugin URI: http://www.woothemes.com/products/authorize-net-cim/
 * Description: Haris (Fudugo) Added required functionality for the Autoship plugin. Based on WooCommerce Authorize.net CIM Gateway.
 * Author: Haris Fudugo
 * Original Author: SkyVerge
 * Original Author URI: http://www.skyverge.com
 * Original Version: 1.1
 * Text Domain: woocommerce-authorize-net-cim-haris
...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '2.0', 'IGNORE THIS MESSAGE, Update not required (WooCommerce Authorize.net CIM Gateway)', __FILE__, 'init_woocommerce_gateway_authorize_net_cim' );
