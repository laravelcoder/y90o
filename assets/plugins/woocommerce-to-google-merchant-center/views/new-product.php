...
<div class="wrap wogo-single-product">
...
$shop_field['targetCountry'] = array(
    'type'  => 'select',
    'label' => __( 'Target Country', 'wogo' ),
    'class'    => 'wogo-target-country',
    'desc'  => 'Should be according with your content language. The two-letter ISO 3166 country code for the item.
    ...
    'option' => woogoo_countrys(),
    'selected' => isset( $product['targetCountry'] ) ? $product['targetCountry'] : '',
);
...
$shop_field['contentLanguage'] = array(
    ...
    //'class'    => 'wogo-chosen',
    'desc'  => 'Should be according with your target country. The two-letter ISO 639-1 language code for the item.
    ...
    'option' => woogoo_content_language(),
